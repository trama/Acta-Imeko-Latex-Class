...
\author[1,2]{Federico Tramarin}%{F. Tramarin}
\abbreviated[1]{F. Tramarin}
\author[1,3]{Agata Tramarin}%{F. Tramarin}
\abbreviated[2]{A. Tramarin}
\author[1,4]{Tommaso Tramarin}%{F. Tramarin}
\abbreviated[3]{T. Tramarin}
...
\affiliation[3]{National Research Council of Italy, CNR-IEIIT, Italy}
\affiliation[4]{National Research Council of Italy, CNR-IEIIT, Italy}
\CorrespondingAuthorNumber{1}
\CorrespondingAuthorEmail{tramarin@unimore.it}

 \authortest{name={Federico},
 	surname={Tramarin},
 	abbreviation={F. Tramarin}
 	}
