...
%\Authors{Thomas Bruns\AuthorRefmark{1}, Dirk Röske\AuthorRefmark{2}, Paul P. L. Regtien\AuthorRefmark{2}, Francisco Alegria\AuthorRefmark{3}, Corey Stambaugh\AuthorRefmark{1}} % Authors

%\AuthorsNew[1]{Federico}

%\affiliation{\AuthorRefmark{1}\textit{Physikalisch-Technische Bundesanstalt, Bundesallee 100, 38116 Braunschweig, Germany}} % Author affiliation 2
%
%\affiliation{\AuthorRefmark{2}\textit{Measurement Science Consultancy, Julia Culpstraat 66, 7558JB Hengelo, The Netherlands}} % Author affiliation 1
%
%\affiliation{\AuthorRefmark{3}\textit{Instituto de Telecomunicações and Instituto Superior Técnico, Universidade Técnica de Lisboa, Av. Rovisco Pais 1, 1049-001 Lisbon, Portugal}} % Author affiliation 2

\author[1]{Thomas Bruns\corref{cor}}
\author[2]{Dirk Röske}
...
\CorAuthor{\CorrespAut\ Corey Stambaugh, e-mail: corey.stambaugh@nist.gov} %enter corresponding author information
%----------------------------------------------------------------
...
\Citation{\AuthorsNames\ Template for an Acta IMEKO paper, Acta IMEKO, vol. A, no. B, article C, Month Year, identifier: IMEKO-ACTA-A (Year)-B-C}
