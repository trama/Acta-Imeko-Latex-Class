...
The class has been tested in a broad range of cases, but some bugs could still be present. If you think you found a bug, or are experiencinuses the environments and commands defined in \LaTeX{} kernel
