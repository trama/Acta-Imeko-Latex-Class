...
\documentclass[10pt]{style_src/imeko_acta}
%\tracingmacros = 1
...
\ArticleNumber{5}
\Identifier{}
%\PageNumbers{1 - \pageref{LastPage}}
...
\backgroundsetup{contents={\includegraphics[width=21cm]{originalwordtemplate/tmp-1page.pdf}}, scale=1,angle=0,opacity=0.1}
...
\backgroundsetup{contents={\includegraphics[width=21cm]{originalwordtemplate/tmp-2page.pdf}}, scale=1,angle=0,opacity=0.1}
\BgThispage
...
\backgroundsetup{contents={\includegraphics[width=21cm]{originalwordtemplate/tmp-4page.pdf}}, scale=1,angle=0,opacity=0.1}
\BgThispage
...
\backgroundsetup{contents={\includegraphics[width=21cm]{originalwordtemplate/tmp-5page.pdf}}, scale=1,angle=0,opacity=0.1}
%\BgThispage
...
\bibliographystyle{style_src/imeko_acta}
