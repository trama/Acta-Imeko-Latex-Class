...
\begin{abstract}
	...
	This class has been created with the intention of requiring the most reasonable minimum effort to the users (authors of papers) in term of packages to load and options to specify.
